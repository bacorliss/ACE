...
if (file.exists(file.path(base_dir, "/temp/df_relative_neg.RDS"))) {
  load(file = paste(base_dir, "/temp/df_relative_neg.RDS",sep=""))
} else {  df_relative_neg = list();
}
...
df_init <- generate_population_configs(n_samples=n_samples, n_sims=n_sims, rand.seed=rand.seed, 
                                   mus_1a  = 100, 
                                   sigmas_1a = 1, 
                                   rmus_1d  = -runif(n_sims, 0.01, 0.03), 
                                   rsigmas_1d = 0.035,
                                   
                                   mus_2a  = 1000, 
                                   sigmas_2a = 1,
                                   rmus_2d  = -runif(n_sims, 0.01, 0.03), 
                                   rsigmas_2d = 0.035,
                                   ...
                                   agreement = "lat")  
df_relative_neg[[1]] <- process_agreement_contest(df_init, gt_colname = gt_colnames, 
...
df_init <- generate_population_configs(n_samples=n_samples, n_sims=n_sims, rand.seed=rand.seed, 
                                   ...
                                   gt_colnames=gt_colnames,
                                   agreement = "lat")  
df_relative_neg[[2]] <- process_agreement_contest(df_init, gt_colname = gt_colnames, 
                                    y_ax_str = "r*sigma[D]",
                                    include_bf = include_bf, parallel_sims = parallel_sims,
                                    fig_name = paste(fig_name, ".tiff",sep = ""),
                                    fig_path = fig_path, stat_exclude_list = NULL,
...
df_init <- generate_population_configs(n_samples=n_samples, n_sims=n_sims, rand.seed=rand.seed, 
                                   ...
                                   gt_colnames=gt_colnames,
                                   agreement = "lat")  
df_relative_neg[[3]] <- process_agreement_contest(df_init, gt_colname = gt_colnames, 
                                                   y_ax_str = "df[D]", 
                                                   include_bf = include_bf, parallel_sims = parallel_sims,
                                                   fig_name = paste(fig_name, ".tiff",sep = ""),
                                                   fig_path = fig_path, stat_exclude_list = NULL,
...
df_init <- generate_population_configs(n_samples=n_samples, n_sims=n_sims, rand.seed=rand.seed, 
                                   ...
                                   gt_colnames = gt_colnames,
                                   agreement = "lat")   
df_relative_neg[[4]] <- process_agreement_contest(df_init, gt_colname = gt_colnames, 
                                                   y_ax_str = "alpha[DM]",
                                                   include_bf = include_bf, parallel_sims = parallel_sims,
                                                   fig_name = paste(fig_name, ".tiff",sep = ""),
                                                   fig_path = fig_path, stat_exclude_list = NULL,
...
gt_colnames = c("is_rmudm_1lat2","is_rsigmad_1lat2", "is_dfdm_1lat2","is_alpha_1lat2")
...
save(df_relative_neg, file = paste(base_dir, "/temp/df_relative_neg.RDS",sep=""))