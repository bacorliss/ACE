...
df_init <- generate_population_configs(n_samples=n_samples, n_sims=n_sims, rand.seed=rand.seed, 
                                   ...
                                   agreement = "lat")  
df_relative_neg[[1]] <- process_strength_contest(df_init, gt_colname = gt_colnames, 
...
df_init <- generate_population_configs(n_samples=n_samples, n_sims=n_sims, rand.seed=rand.seed, 
                                   ...
                                   gt_colnames=gt_colnames,
                                   agreement = "lat")  
df_relative_neg[[2]] <- process_strength_contest(df_init, gt_colname = gt_colnames, 
                                    y_ax_str = "r*sigma[D]",
                                    include_bf = include_bf, parallel_sims = parallel_sims,
                                    fig_name = paste(fig_name, ".tiff",sep = ""),
                                    fig_path = fig_path, stat_exclude_list = NULL,
...
df_init <- generate_population_configs(n_samples=n_samples, n_sims=n_sims, rand.seed=rand.seed, 
                                   ...
                                   gt_colnames=gt_colnames,
                                   agreement = "lat")  
df_relative_neg[[3]] <- process_strength_contest(df_init, gt_colname = gt_colnames, 
                                                   y_ax_str = "df[D]", 
                                                   include_bf = include_bf, parallel_sims = parallel_sims,
                                                   fig_name = paste(fig_name, ".tiff",sep = ""),
                                                   fig_path = fig_path, stat_exclude_list = NULL,
...
df_init <- generate_population_configs(n_samples=n_samples, n_sims=n_sims, rand.seed=rand.seed, 
                                   ...
                                   gt_colnames = gt_colnames,
                                   agreement = "lat")   
df_relative_neg[[4]] <- process_strength_contest(df_init, gt_colname = gt_colnames, 
                                                   y_ax_str = "alpha[DM]",
                                                   include_bf = include_bf, parallel_sims = parallel_sims,
                                                   fig_name = paste(fig_name, ".tiff",sep = ""),
                                                   fig_path = fig_path, stat_exclude_list = NULL,
